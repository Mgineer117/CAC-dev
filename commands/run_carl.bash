...
python3 main.py --project Exp-Contraction --task cartpole --algo-name carl &
sleep 3
python3 main.py --project Exp-Contraction --task segway --algo-name carl &
sleep 3
python3 main.py --project Exp-Contraction --task turtlebot --algo-name carl &
sleep 3
python3 main.py --project Exp-Contraction --task car --algo-name carl &
sleep 3
python3 main.py --project Exp-Contraction --task pvtol --algo-name carl &
sleep 3
python3 main.py --project Exp-Contraction --task neurallander --algo-name carl &
sleep 3
python3 main.py --project Exp-Contraction --task quadrotor --algo-name carl &
