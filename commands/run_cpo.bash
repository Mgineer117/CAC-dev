...
python3 main.py --project Exp-Contraction --task cartpole --algo-name cpo &
sleep 3
python3 main.py --project Exp-Contraction --task segway --algo-name cpo &
sleep 3
python3 main.py --project Exp-Contraction --task turtlebot --algo-name cpo &
sleep 3
python3 main.py --project Exp-Contraction --task car --algo-name cpo &
sleep 3
python3 main.py --project Exp-Contraction --task pvtol --algo-name cpo &
sleep 3
python3 main.py --project Exp-Contraction --task neurallander --algo-name cpo &
sleep 3
python3 main.py --project Exp-Contraction --task quadrotor --algo-name cpo &
