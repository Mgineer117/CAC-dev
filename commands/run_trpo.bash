...
python3 main.py --project Exp-Contraction --task cartpole --algo-name trpo &
sleep 3
python3 main.py --project Exp-Contraction --task segway --algo-name trpo &
sleep 3
python3 main.py --project Exp-Contraction --task turtlebot --algo-name trpo &
sleep 3
python3 main.py --project Exp-Contraction --task car --algo-name trpo &
sleep 3
python3 main.py --project Exp-Contraction --task pvtol --algo-name trpo &
sleep 3
python3 main.py --project Exp-Contraction --task neurallander --algo-name trpo &
sleep 3
python3 main.py --project Exp-Contraction --task quadrotor --algo-name trpo &
